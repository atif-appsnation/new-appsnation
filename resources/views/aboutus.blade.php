		...
		<div class="row justify-content-between">
			<div class="col-md-12 col-lg-8 mt-5 order-2 order-lg-1 my-sm-auto wow fadeIn">
				...
				<div class="row about-bages-slides-div">
					<div class="col-md-8">
						<div class="about-bages-slider owl-carousel owl-theme">
							<div class="h-img">
...
<section id="mycounterSection" class="py-5 scale-up-services-section">
	<div class="container">
		<div class="row">
			<div class="col-lg-7 col-md-12 order-2 order-lg-1 d-flex align-items-center wow fadeIn">
				<div>
			...
			<div class="col-lg-5 col-md-12 text-center order-1 order-lg-2 wow fadeIn">
				<img loading="lazy" src="images/about-us/about-us.webp" width="auto" height="auto" alt="About Us" class="img-fluid block mx-auto">
			</div>
		</div>
		<div class="row justify-content-center achievements-count mt-3 wow fadeIn">
...
<section class="why-choose-us py-5">
	<div class="container">
		...
		<div class="row upset mt-lg-5 wow fadeIn">
...
<section class="vision-section py-5 wow fadeIn">
	<div class="container">
		...
		<div class="tab-content">
			<div class="tab-pane fade show active" id="mission">
				<div class="row align-items-center g-4">
					...
					<div class="col-lg-6 text-center">
						<img loading="lazy" src="images/about-us/mission.webp" class="img-fluid vision-img" alt="Mission">
					</div>
				</div>
			</div>
			<div class="tab-pane fade" id="vision">
				<div class="row align-items-center g-4">
					...
					<div class="col-lg-6 text-center">
						<img loading="lazy" src="images/about-us/vision.webp" class="img-fluid vision-img" alt="Vision">
					</div>
				</div>
			</div>
			<div class="tab-pane fade" id="values">
				<div class="row align-items-center g-4">
					...
					<div class="col-lg-6 text-center">
						<img loading="lazy" src="images/about-us/value.webp" class="img-fluid vision-img" alt="Values">
					</div>
				</div>
			</div>
		</div>
...
<section class="py-5 wow fadeIn">
	<div class="container">
		<div class="row">
			...
			<div class="col-12">
				<img loading="lazy" src="images/about-us/our-team.webp" class="img-fluid d-block mx-auto">
			</div>
		</div>
	</div>
</section>
