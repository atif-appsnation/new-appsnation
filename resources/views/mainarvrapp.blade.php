	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-sm-12 col-md-6 mt-4 mt-md-auto wow fadeIn">
				<!-- <img loading="lazy" src="images/ar-app-development/ar-app-banner-img.webp" class="img-fluid" alt="Connected Devices"> -->
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-5 my-auto wow fadeIn">
				<div class="image-block">
					<img loading="lazy" src="images/services/ar-vr-app-development/ar-vr.webp" alt="AR VR" class="img-fluid no-shadow" />
				</div>
			</div>
