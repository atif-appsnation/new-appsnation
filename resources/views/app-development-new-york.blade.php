		...
		<div class="row">
			...
			<div class="col-lg-5">
				<div class="image-block wow fadeIn">
					 <img loading="lazy" src="images/locations/new-york/new-york.webp" alt="New York" class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 block-1 wow fadeIn">
				 <img loading="lazy" src="images/locations/new-york/scale-your-business.webp" alt="Scale Your Business" class="img-fluid" width="100%" height="100%">
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-12">
				<div class="owl-carousel owl-theme services-carousel">
					...
					<div class="item">
						 <img loading="lazy" src="images/locations/services/web-portal-development.webp" alt="Web Portal Development" class="img-fluid" width="100%" height="100%">
						<div class="text">
					...
					<div class="item">
						 <img loading="lazy" src="images/locations/services/xr-app-development.png" alt="XR Development" class="img-fluid" width="100%" height="100%">
						<div class="text">
					...
					<div class="item">
						 <img loading="lazy" src="images/locations/services/connected-devices.webp" alt="Connected Devices" class="img-fluid" width="100%" height="100%">
						<div class="text">
					...
					<div class="item">
						 <img loading="lazy" src="images/locations/services/design-and-animation-services.webp" alt="Design & Automation Services" class="img-fluid" width="100%" height="100%">
						<div class="text">
