		...
		<div class="row">
			<div class="col-lg-5">
				<div class="image-block wow fadeIn">
					 <img loading="lazy" src="images/services/2d-art/2d-art-development.webp" alt="2D Art Development" class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#realistic">
                                             <img loading="lazy" src="images/services/2d-art/realistic-character-design.webp" alt="2D 2D Realistic Character Design" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Realistic Character Design</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#causal">
                                             <img loading="lazy" src="images/services/2d-art/casual-character-design.webp" alt="2D 2D Causal Character Design" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Causal Character Design</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#cartoon">
                                             <img loading="lazy" src="images/services/2d-art/cartoon-character-design.webp" alt="2D 2D Cartoon Character Design" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Cartoon Character Design</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#stylized">
                                             <img loading="lazy" src="images/services/2d-art/stylized-character-design.webp" alt="2D 2D Stylized Character Design" class="img-fluid d-block mx-auto" width="100%" height="100%">
                            ...
                            <div class="col-lg-6">
                                <div class="tab-content">
                                    <div class="tab-pane container active" id="realistic">
                                         <img loading="lazy" src="images/services/2d-art/realistic-character-design.webp" alt="2D 2D Realistic Character Design" class="img-fluid twod-character-design-img" width="100%" height="100%">
                                    ...
                                    <div class="tab-pane container fade" id="causal">
                                         <img loading="lazy" src="images/services/2d-art/casual-character-design.webp" alt="2D 2D Causal Character Design" class="img-fluid twod-character-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="cartoon">
                                         <img loading="lazy" src="images/services/2d-art/cartoon-character-design.webp" alt="2D 2D Cartoon Character Design" class="img-fluid twod-character-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="stylized">
                                         <img loading="lazy" src="images/services/2d-art/stylized-character-design.webp" alt="2D 2D Stylized Character Design" class="img-fluid twod-character-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                        	...
                        	<div class="col-lg-6">
                                <div class="tab-content">
                                    <div class="tab-pane container active" id="game">
                                         <img loading="lazy" src="images/services/2d-art/game-environments.webp" alt="2D Game Environment Design" class="img-fluid twod-environment-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="map-levels">
                                         <img loading="lazy" src="images/services/2d-art/map-levels.webp" class="img-fluid twod-environment-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="biomes">
                                         <img loading="lazy" src="images/services/2d-art/biomes-environment.webp" alt="2D Biomes Environment Design" class="img-fluid twod-environment-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="urban">
                                         <img loading="lazy" src="images/services/2d-art/urban-environments.webp" alt="2D 2D Urban Environment Design" class="img-fluid twod-environment-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#game">
                                             <img loading="lazy" src="images/services/2d-art/game-environments.webp" alt="2D Game Environment Design" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Game Environments </p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#map-levels">
                                             <img loading="lazy" src="images/services/2d-art/map-levels.webp" alt="2D Map Environment Design" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Maps &amp; Levels</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#biomes">
                                             <img loading="lazy" src="images/services/2d-art/biomes-environment.webp" alt="2D Biomes Environment Design" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Biomes</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#urban">
                                             <img loading="lazy" src="images/services/2d-art/urban-environments.webp" alt="2D Urban Environment Design" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#ui-ux">
                                             <img loading="lazy" src="images/services/2d-art/mobile-game-ui-ux.webp" alt="2D Mobile Game App UI/UX Design" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Mobile Game App UI/UX Design</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#wireframing">
                                             <img loading="lazy" src="images/services/2d-art/mobile-game-wireframes.webp" alt="2D Mobile Game App Wireframing" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Mobile Game App Wireframing</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#ar-game">
                                             <img loading="lazy" src="images/services/2d-art/ar-mobile-games.webp" alt="2D Mobile AR Game App" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Mobile AR Game App</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#vr-game">
                                             <img loading="lazy" src="images/services/2d-art/vr-mobile-games.webp" alt="2D Mobile VR Game App" class="img-fluid d-block mx-auto" width="100%" height="100%">
                            ...
                            <div class="col-lg-6">
                                <div class="tab-content">
                                    <div class="tab-pane container active" id="ui-ux">
                                         <img loading="lazy" src="images/services/2d-art/mobile-game-ui-ux.webp" alt="2D Mobile Game App UI/UX Design" class="img-fluid twod-game-ui-ux-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="wireframing">
                                         <img loading="lazy" src="images/services/2d-art/mobile-game-wireframes.webp" class="img-fluid twod-game-ui-ux-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="ar-game">
                                         <img loading="lazy" src="images/services/2d-art/ar-mobile-games.webp" alt="2D Mobile AR Game App" class="img-fluid twod-game-ui-ux-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="vr-game">
                                         <img loading="lazy" src="images/services/2d-art/vr-mobile-games.webp" alt="2D Mobile VR Game App" class="img-fluid twod-game-ui-ux-design-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                        ...
                        <div class="col-lg-6">
                                <div class="tab-content">
                                    <div class="tab-pane container active" id="character">
                                         <img loading="lazy" src="images/services/2d-art/character-concept-art.webp" alt="2D Character Concept Art" class="img-fluid twod-concept-art-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="environment">
                                         <img loading="lazy" src="images/services/2d-art/environment-concept-art.webp" alt="2D Environment Concept Art" class="img-fluid twod-concept-art-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="level">
                                         <img loading="lazy" src="images/services/2d-art/level-design-concept-art.webp" alt="2D Level Design Concept" class="img-fluid twod-concept-art-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                    ...
                                    <div class="tab-pane container fade" id="concept">
                                         <img loading="lazy" src="images/services/2d-art/vehicles-and-guns-concept-art.webp" alt="2D Concepts of Vehicles, Weapons, and Props" class="img-fluid twod-concept-art-img" width="100%" height="100%">
                                        <div class="twod-art-bottom-center">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#character">
                                             <img loading="lazy" src="images/services/2d-art/character-concept-art.webp" alt="2D Character Concept Art" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Character Concept Art</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#environment">
                                             <img loading="lazy" src="images/services/2d-art/environment-concept-art.webp" alt="2D Environment Concept Art" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Environment Concept Art</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#level">
                                             <img loading="lazy" src="images/services/2d-art/level-design-concept-art.webp" alt="2D Level Design Concept" class="img-fluid d-block mx-auto" width="100%" height="100%">
                                            <p class="text-center">Level Design Concept</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#concept">
                                             <img loading="lazy" src="images/services/2d-art/vehicles-and-guns-concept-art.webp" alt="2D Concepts of Vehicles, Weapons, and Props" class="img-fluid d-block mx-auto" width="100%" height="100%">
    ...
    <div class="container">
		<div class="row">
			<div class="col-xl-6 my-auto">
				...
				<p class="pt-2 text-white">Looking for a dedicated 2D Art Designer having a good experience? You are at the right place for our clients AppsNation also provides dedicated design resources. Our designers are capable of completing the complicated task in no time. Contact us today to get started!</p>
				...
				<div class="row scroller">
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="card stack-hov">
							<div class="card-body">
								 <img loading="lazy" src="images/tech/photoshop-logo.webp" class="img-fluid d-block mx-auto" alt="2D Photoshop" width="auto" height="auto">
					...
					<div class="col-sm-6 col-md-6 col-lg-4 mt-3 mt-md-0">
						<div class="card stack-hov">
							<div class="card-body">
								 <img loading="lazy" src="images/tech/illustrator-logo.webp" class="img-fluid d-block mx-auto" alt="2D Illustrator" width="auto" height="auto">
					...
					<div class="col-sm-6 col-md-6 col-lg-4 mt-3 mt-lg-0">
						<div class="card stack-hov">
							<div class="card-body">
								 <img loading="lazy" src="images/tech/after-effects-logo.webp" class="img-fluid d-block mx-auto" alt="2D After Effects" width="auto" height="auto">
					...
					<div class="col-sm-6 col-md-6 col-lg-4 mt-3">
						<div class="card stack-hov">
							<div class="card-body">
								 <img loading="lazy" src="images/tech/xd-logo.webp" class="img-fluid d-block mx-auto" alt="2D XD" width="auto" height="auto">
					...
					<div class="col-sm-6 col-md-6 col-lg-4 mt-3">
						<div class="card stack-hov">
							<div class="card-body">
								 <img loading="lazy" src="images/tech/figma-logo.webp" class="img-fluid d-block mx-auto" alt="2D Figma" width="auto" height="auto">
