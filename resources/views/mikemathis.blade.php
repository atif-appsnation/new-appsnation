        ...
        <div class="row">
            <div class="col-lg-6 my-lg-auto">
                <div class="bread-titlev2 mt-4">
                    ...
                    <h1 class="mb-3">Mentoring <br> with the Mentees Space to Grow </h1>
            ...
            <div class="col-lg-6 mt-5 mt-lg-0 mike-mathis-hero-img">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/hero-img-mikemathis.webp')}}" class="img-fluid" alt="mike-mathis-app">
            </div>
        </div>
    </div>
...
<section class="mike-mathis-design-phase my-5">
    <div class="container">
...
<!-- Start Project Description Statement Section -->
<section class="Project-Description mike-mathis-project">
    <div class="container">
        <div class="row align-items-center  text-start">
            <div class="col-12 col-md-12 col-lg-6 mb-4 mb-md-0 Project-Description-left-container">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/project-description.webp')}}" class="img-fluid" alt="Project">
            </div>
            <div class="col-12 col-md-12 col-lg-6 uiux-text-col">
                <div class="Project-Description-content-block">
                    <h2 class="Project-Description-title">Project Description</h2>
                    <p class="Project-Description-titleparagraph"> Royal Ride began with a single realization: though Qatar was a country with the top transportation services, the digital experience was yet to be matched. Visitors in Doha, who are business people or VIP visitors, want to have a smooth, high-end and dependable experience when making a luxury ride. The popularity of reservation transfer system Qatar App keeps growing year after year, and the requests are to be addressed by the novel Qatar ride booking app. </p>
                </div>
            </div>
        </div>
    </div>
...
<section class="Objectives-section mike-mathis-Objectives mike-mathis-goals">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 d-flex justify-content-center mb-5 mb-lg-0">
                <div class="phone-screen">
                    <img loading="lazy" src="{{ asset('images/case-studies/mike-mathis-app/project-goals.webp') }}" alt="Project Goals">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            ...
            <div class="col-12 col-md-12 col-lg-6 mb-4 mb-md-0 Project-Challenges-left-container">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/project-challenges.webp')}}" class="img-fluid" alt="Project Challanges">
            </div>
        </div>
    </div>
</section>
...
<section class="user-research mike-mathis-user-research my-5">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/user-rsearch.webp')}}" class="img-fluid" alt="User Research">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row g-3 mike-mathis-wireframe-gallery">
            <div class="col-6 col-md-6 col-xl-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/wireframe1.webp')}}" alt="Mike Mathis Wireframe" class="wire-img">
            </div>
            <div class="col-6 col-md-6 col-xl-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/wireframe2.webp')}}" alt="Mike Mathis Wireframe" class="wire-img">
            </div>
            <div class="col-6 col-md-6 col-xl-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/wireframe3.webp')}}" alt="Mike Mathis Wireframe" class="wire-img">
            </div>
            <div class="col-6 col-md-6 col-xl-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/wireframe4.webp')}}" alt="Mike Mathis Wireframe" class="wire-img">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen1.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen2.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen3.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen4.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen5.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen6.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen7.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen8.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen9.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen10.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen11.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen12.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen13.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen14.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen15.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-3 col-6 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/appscreen16.webp')}}" alt="App Screens" class="img-fluid">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <img loading="lazy" src="{{asset('images/case-studies/mike-mathis-app/morkup.webp')}}" alt="Mockup" class="img-fluid">
            </div>
        </div>
    </div>
</section>
