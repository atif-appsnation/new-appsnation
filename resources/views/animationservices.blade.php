		...
		<div class="row">
			<div class="col-lg-5">
				<div class="image-block wow fadeIn">
					<img loading="lazy" src="images/banner/animation-banner-img.png" alt="Animation Development" class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
			<div class="col-lg-7 block-1 wow fadeIn my-auto">
				<div class="common-heading text-l pl25">
					...
					<p>AppsNation is an expert in 3D animation and a wide variety of other animation services that may help your company get more attention and engage more users online. We use our years of expertise in the business to combine cutting-edge methods with creativity to make animations that look great and get results. We can create precisely what you need, whether it's animated movie creation, motion graphics animation services, or corporate animation services. </p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-12 text-center">
				<div class="common-heading">
					...
					<p>We have a lot of different animation services that are made to fit your business's demands and get the most people involved:</p>
				</div>
			</div>
		</div>
		<div class="row d-flex justify-content-center mt-5">
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="service-card-app h-100">
					<h3>3D Animation</h3>
					<p>Our 3D animation services will help your brand grow. Our talented team makes high-quality 3D animations that help people understand complicated ideas, bring products to life, and keep your audience's attention. We make 3D graphics that stand out, from commercial animation videos to immersive experiences.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="service-card-app h-100">
					<h3>2D Animation</h3>
					<p>Our 2D animation services are great for organizations who want a more conventional but yet interesting form of animation. Our team makes high-quality 2D animations that effectively get your point across, whether you require simple character animations, explainer movies, or instructional material.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="service-card-app h-100">
			...
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="service-card-app h-100">
					...
					<p>With dynamic motion graphics animation services, you can make your brand's message stronger. Our motion graphics make your material come to life by adding moving parts that make it more interesting and encourage people to act. Motion graphics are great for product demonstrations, promotional films, and digital marketing campaigns because they grab people's attention and keep them interested.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="service-card-app h-100">
					<h3>Whiteboard Animation</h3>
					<p>We turn your thoughts into unique, hand-drawn pictures with our whiteboard animation services. These movies are great for breaking down hard ideas into simple terms. Our whiteboard animations make communication easier and add an interesting touch to your material with clear drawings and professional voiceovers.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="service-card-app h-100">
					<h3>Corporate Animation</h3>
					<p>Corporate animation services may help your business stand out. We make professional, high-quality animations for businesses that show off your brand's strengths and services. We make sure that your animated corporate movie or business entrance video fits with your firm's vision and aims, whether you need it for marketing or anything else.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="service-card-app h-100">
					<h3>Animated Logo</h3>
					<p>Our unique 3D animated logo design services can help you make your brand stand out. A logo that moves and changes may make your firm stand out and create a memorable impression. We'll help you create a one-of-a-kind, creative animated logo that precisely reflects your brand's values and grabs the attention of your target audience.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="service-card-app h-100">
					<h3>Flat Design Animation</h3>
					<p>Our bespoke flat design video animation services are a great choice if you want a clean, simple look. Our flat design animations get your point over in a visually interesting manner while maintaining loyal to your brand's style. They are both simple and sophisticated.</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 block-1 wow fadeIn pt-3 pt-sm-3 pt-md-3 pt-lg-0">
				<img loading="lazy" src="images/banner/animation-graphic.png" alt="AR Game Changer" class="img-fluid" width="100%" height="100%">
			</div>
		...
		<div class="row upset justify-content-center mt30">
			<div class="col-12 col-md-6 col-lg-4">
				<div class="timeline wow fadeIn h-100">
					...
					<p class="description">The first step is to know your objectives and who you want to reach. We look at what you need for your project to find the best animation style and method.</p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3 mt-md-0">
				<div class="timeline wow fadeIn h-100">
					<p class="timeline-year">02</p>
					<h3 class="title">Making a plan</h3>
					<p class="description">We make a custom plan that fits with your company objectives based on what you tell us. We make sure that everything, from stylistic decisions to technical execution, is in accordance with your vision. </p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3 mt-lg-0">
				<div class="timeline wow fadeIn h-100">
					<p class="timeline-year">03</p>
					<h3 class="title">Design and Storyboarding</h3>
					<p class="description">We make thorough storyboards to plan out every part of the animation. Thishelps us picture the finished result and makes sure you agree with the design before we go on. </p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					<p class="timeline-year">04</p>
					<h3 class="title">Making Animations </h3>
					<p class="description">We bring the storyboard to life using innovative animation methods, giving people, objects, and backdrops life with style and accuracy.</p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					...
					<p class="description">We do a lot of testing and make changes to make sure everything works flawlessly. This involves checking the visuals, making sure the sound is in sync, and making sure it works on multiple platforms. </p>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					<p class="timeline-year">06</p>
					<h3 class="title">Last Delivery </h3>
					<p class="description">After we have your approval, we make the animation work better for different formats and send it to all the platforms you need, making sure it's ready to be shared.</p>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="card h-100">
							<div class="card-body">
								<a href="https://www.designrush.com/agency/profile/appsnation" target="_blank">
									...
									<img loading="lazy" src="images/reviews/star.webp" class="img-fluid d-block mx-auto" alt="Star"width="auto" height="auto">
									<p class="text-center pt-2 text-black">Recognized as Top App Developers byDesignRush</p>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="card h-100">
							<div class="card-body">
								<a href="https://www.trustpilot.com/review/appsnation.co" target="_blank">
									...
									<img loading="lazy" src="images/reviews/star.webp" class="img-fluid d-block mx-auto" alt="Star" width="auto" height="auto">
									<p class="text-center pt-2 text-black">Recognized as Top App Developers byTrustpilot</p>
								</a>
							</div>
						</div>
					</div>
							...
							<div class="accordion-body">
								<div class="data-reqs">
									<p>We ensure that you receive everything from your project by using our most
										...
										unlimited revisions to ensure the client is satisfied with us while maintaining our outstanding customer satisfaction bar.</p>
								</div>
							</div>
						</div>
					</div>
