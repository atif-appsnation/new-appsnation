		...
		<div class="row">
			...
			<div class="col-lg-5">
				<div class="image-block wow fadeIn">
					 <img loading="lazy" src="images/locations/los-angeles/los-angeles.webp" alt="Los Angeles" class="img-fluid no-shadow" />
				</div>
			</div>
		</div>
	</div>
...
<div class="row justify-content-center hire-developer hire-developer-app-development">
	<div class="col-lg-7">
		...
		<div class="hire-developer-img d-none d-xl-block">
			 <img loading="lazy" src="images/locations/hire-developer.webp" alt="Hire Developer" class="img-fluid">
		</div>
	</div>
</div>
