...
<section class="load-board-project-overview py-5">
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            <div class="col-12 col-md-12 col-lg-6 mt-md-4 ">
                <div class="load-board-project-overview-contant">
                    ...
                    <h4 class="mb-4">About the App</h4>
...
<section class="load-board-problem-challenges py-5">
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            <div class="col-12 col-md-12 col-lg-6">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-problem-challenges.webp')}}" class="img-fluid oad-board-problem-challenges-image" alt="Load Board Problem Challanges">
            </div>
            <div class="col-12 col-md-12 col-lg-6 mt-4 my-lg-auto">
                <h2 class="mb-4">Problem Challenges</h2>
                <h4 class="mb-4">About the App</h4>
...
<section class="load-board-tech py-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="mb-4 text-white">Tools & Technologies We Used</h2>
                <p class="text-white">Take a look behind the scenes of the Loadboard platform — a high-performance logistics system built to support smart dispatching, real-time tracking, and seamless operations. Each technology was carefully selected to ensure fast performance, reliable data sync, and a consistent experience across both web and mobile platforms.</p>
            </div>
        </div>
...
<section class="load-board-infographic py-5">
	<div class="container">
                ...
                <div class="col-md-4">
                    <div class="persona-card persona-left-column-card">
                        <div class="persona-name-section">
                            <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-avatar-01.webp')}}" alt="Avatar" class="img-fluid">
        ...
        <div class="container persona-section-wrapper">
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="persona-card persona-left-column-card">
                        <div class="persona-name-section">
                            <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-avatar-02.webp')}}" alt="Ahmed Al-Kuwari Avatar">
                            <h4>Jason Carter</h4>
...
<!-- Start App Screens -->
<section class="load-board-carrier-screen py-5">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-carrier-module-screen-05.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-carrier-module-screen-01.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-carrier-module-screen-02.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-carrier-module-screen-03.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-carrier-module-screen-04.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-carrier-module-screen-06.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-carrier-module-screen-07.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-carrier-module-screen-08.webp')}}" alt="App Screens" class="img-fluid">
            </div>
        </div>
    </div>
</section>
...
<section class="load-board-carrier-screen py-5 load-board-app-screen">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-brooker-module-01.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-brooker-module-02.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-brooker-module-03.webp')}}" alt="App Screens" class="img-fluid">
            </div>
            <div class="col-md-6 col-12 my-3">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-brooker-module-04.webp')}}" alt="App Screens" class="img-fluid">
            </div>
        </div>
    </div>
</section>
...
<section class="load-board-mockup">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <img loading="lazy" src="{{asset('images/case-studies/load-board/load-board-mockup.webp')}}" alt="Load Board Mockup" class="img-fluid">
            </div>
        </div>
    </div>
</section>
